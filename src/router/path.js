...
export const DEVICE_EDIT = require('../page/device/deviceEdit.vue')
...
export const USERS_EDIT = require('../page/user/usersEdit.vue')
export const USERS_DETAIL = require('../page/user/usersDetail.vue')
export const ROLES_ADD = require('../page/user/rolesAdd.vue')
export const ROLES_EDIT = require('../page/user/rolesEdit.vue')
