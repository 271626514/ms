    ...
    <div>
        ...
        <Form :model="formItem" :label-width="120" :rules="userAdd" ref="add">
            <Form-item label="账号" prop="username">
                <Input v-model="formItem.username" placeholder="6-50位字母或数字"></Input>
            </Form-item>
            <Form-item label="密码" prop="password">
                <Input v-model="formItem.password" placeholder="8-20位大小写字母或数字组合" type="password"></Input>
            </Form-item>
            ...
            <Form-item label="邮箱地址" prop="email">
                <Input v-model="formItem.email" placeholder="邮箱是找回密码的重要依据，请务必填写正确"></Input>
            </Form-item>
            ...
            <Form-item>
                <Button type="primary" style="width: 80px" @click="handleSubmit('add')">创建</Button>
                <Button type="ghost" style="margin-left: 8px; width: 80px" @click="$router.push('/user')">取消</Button>
            </Form-item>
        </Form>
    </div>
</template>
